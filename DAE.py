...
class DAE(object):
    ...
    def train(train_set_x, train_set_y, valid_set_x, valid_set_y, learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, batch_size=20, n_hidden=500):
        """
        ...
        n_train_batches = train_set_x.get_value(borrow=True).shape[1] / batch_size
